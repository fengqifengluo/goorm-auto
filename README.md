...
### 2、执行以下代码
`bash <(curl -s -L https://raw.githubusercontent.com/fengqifengluo/goorm-auto/master/install.sh)`

### 3、开放内部端口
![image](https://github.com/fengqifengluo/goorm-auto/blob/master/port.png)
